...
public abstract interface MeetingDao {
    ...
    @androidx.room.Query(value = "UPDATE meetings SET autoStartRecording = :autoStart WHERE id = :meetingId")
    @org.jetbrains.annotations.Nullable()
